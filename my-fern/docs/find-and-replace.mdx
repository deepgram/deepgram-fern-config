...
<Info
  icon={<img src="https://res.cloudinary.com/deepgram/image/upload/v1717523786/devex/codey-greeting_rekqe1.svg" alt="Deepgram API Playground" width="48" height="30"/>}
>
  Try this feature out in our [API Playground](https://playground.deepgram.com/?endpoint=listen\&replace=test%3Atest\&language=en\&model=nova-2)!
</Info>
</div>
## Enable Feature
