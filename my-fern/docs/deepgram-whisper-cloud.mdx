...
<Warning>
  Live streaming is not available with Deepgram Whisper Cloud. If you would like to transcribe live streamed audio, we recommend using our Nova-2 model. [This guide](/docs/getting-started-with-live-streaming-audio) can help you get started.
</Warning>
