        ...
        <div className="tw-flex tw-gap-3 tw-items-center">
          <a
            ...
            <button className="tw-rounded-md tw-text-[#BBBBBF] tw-py-2 tw-px-3 tw-flex tw-items-center tw-gap-2">
              <img
                src="https://fern-image-hosting.s3.us-east-1.amazonaws.com/deepgram/sparkle.svg"
                width="16"
                height="16"
                alt="sparkle"
              />
          ...
          <a
            ...
            <button className="tw-rounded-md tw-text-[#BBBBBF] tw-py-2 tw-px-3 tw-flex tw-items-center tw-gap-2">
              <img
                src="https://fern-image-hosting.s3.us-east-1.amazonaws.com/deepgram/Key.svg"
                width="16"
                height="16"
                alt="key"
              />
          ...
          <a href="/" rel="noopener noreferrer">
            <button className="tw-rounded-md tw-text-[#BBBBBF] tw-py-2 tw-px-3 tw-flex tw-items-center tw-gap-2">
              <img
                src="https://fern-image-hosting.s3.us-east-1.amazonaws.com/deepgram/docs-open-book.svg"
                width="16"
                height="16"
                alt="docs"
              />
          ...
          <a
            ...
            <button className="tw-rounded-md tw-text-[#BBBBBF] tw-py-2 tw-px-3 tw-flex tw-items-center tw-gap-2">
              <img
                src="https://fern-image-hosting.s3.us-east-1.amazonaws.com/deepgram/community-users.svg"
                width="16"
                height="16"
                alt="community"
              />
