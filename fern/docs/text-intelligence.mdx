...
<span>
<img src="https://res.cloudinary.com/deepgram/image/upload/v1717523786/devex/codey-greeting_rekqe1.svg" alt="Deepgram API Playground"/>   Try this feature out in our [API Playground](https://playground.deepgram.com/?endpoint=read\&summarize=v2\&topics=true\&intents=true\&sentiment=true\&language=en)!
</span>
</div>
