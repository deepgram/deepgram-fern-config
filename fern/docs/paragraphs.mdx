...
[Pre-recorded](/docs/getting-started-with-pre-recorded-audio) Streaming [All in which words are delimited by spaces](/docs/models-languages-overview)
...
>
  Try this feature out in our [API Playground](https://playground.deepgram.com/?endpoint=listen\&paragraphs=true\&language=en\&model=nova-2)!
</Info>
</div>
