...
<Info>
  This guide walks you through only the function calling creation of a demo application. Please refer to this [code repository](https://github.com/deepgram-devs/flask-agent-function-calling-demo) for the complete application code.
</Info>
