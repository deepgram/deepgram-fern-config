...
>
  Try this feature out in our [API Playground](https://playground.deepgram.com/?endpoint=listen\&summarize=v2\&topics=true\&intents=true\&smart_format=true\&sentiment=true\&language=en\&model=nova-2)!
</Info>
</div>
