...
[Pre-recorded](/docs/getting-started-with-pre-recorded-audio) [Streaming](/docs/getting-started-with-live-streaming-audio) [EN only](/docs/models-languages-overview)
...
>
  Try this feature out in our [API Playground](https://playground.deepgram.com/?endpoint=listen\&redact=pci\&language=en\&model=nova-2)!
</Info>
</div>
