...
Copy the `server.py`code from the [repository](https://github.com/deepgram-devs/deepgram-twilio-streaming-python/blob/nikolawhallon-tts/twilio.py) as we will use this in the steps below and save this code locally as with a file name of `server.py`.
